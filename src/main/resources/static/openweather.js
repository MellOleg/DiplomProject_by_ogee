...
let lat = "lat=53.6834599&";
let lon = "lon=23.8342648&";
let apiOptions = "units=metric&exclude=minutely,alerts&";
let apiKey = "appid=557b5c7b527302034a1bfcfd5dc07bbe";
let lang = "&lang=ru";
...
case "Clear":
document.getElementById("wrapper-bg").style.backgroundImage =
"url('/static/clear.gif')";
break;
case "Thunderstorm":
document.getElementById("wrapper-bg").style.backgroundImage =
"url('/static/thunderstorm.gif')";
break;
default:
document.getElementById("wrapper-bg").style.backgroundImage =
"url('/static/clear.gif')";
